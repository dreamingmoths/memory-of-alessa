...
void GetPlayerPartsLocalMatrix(float (* mat)[4] /* r2 */, u_int parts_name /* r17 */); // I changed this
void GetPlayerPartsWorldMatrix(float (* mat)[4] /* r2 */, u_int parts_name /* r2 */); 
float PlayerGetNeckAngleX(void);                          /* extern */
float PlayerGetNeckAngleY(void);                          /* extern */
float shAtan2(float, float); // this doesnt take arguments from the symbols                                                          /* extern */
void shMulMatrix(float (* m0)[4] /* r2 */, float (* m1)[4] /* r2 */, float (* m2)[4] /* r2 */);                    /* extern */
