...
static signed int title_test_mode; // size: 0x4, address: 0x116D788
...
typedef struct /* @anon3 */ {
    ...
    signed int stg;          // offset 0x10, size 0x4
    signed int jump_nemu_id; // offset 0x14, size 0x4
} TitlePointList;

typedef struct /* @anon6 */ {
    // total size: 0x94
    signed int memcard;       // offset 0x0, size 0x4
    signed int mode;          // offset 0x4, size 0x4
    signed int sel;           // offset 0x8, size 0x4
    float timer;              // offset 0xC, size 0x4
    signed int alpha;         // offset 0x10, size 0x4
    float alphar;             // offset 0x14, size 0x4
    unsigned int menu[10];    // offset 0x18, size 0x28
    struct PicDraw_Data pic0; // offset 0x40, size 0x44
    unsigned char* pload0;    // offset 0x84, size 0x4
    unsigned char* pload1;    // offset 0x88, size 0x4
    signed int texadr;        // offset 0x8C, size 0x4
    signed int clutadr;       // offset 0x90, size 0x4
} TitleDataWork;
