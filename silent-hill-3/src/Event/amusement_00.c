...
INCLUDE_ASM("asm/nonmatchings/Event/amusement_00", func_01F6D740_amusement_00);
...
INCLUDE_ASM("asm/nonmatchings/Event/amusement_00", func_01F6E020_amusement_00);
...
u32 func_01F6E6A0_amusement_00(s32 arg0) {
    int x;
    switch (arg0) {
        case 1:
        x = (D_1D3169C >> 9) & 1 ? 0 : 1;
