#ifndef SH3GFW_STRUCTS_H
#define SH3GFW_STRUCTS_H
...
typedef struct sh3gfw_BLOCK_HEAD {
    // total size: 0x30
...
typedef struct sh3gfw_BLOCKGLOBAL_HEAD {
    // total size: 0x10
...
} sh3gfw_BLOCKGLOBAL_HEAD;

typedef struct sh3gfw_BLOCKLOCAL_HEAD {
    // total size: 0x10
...
} sh3gfw_BLOCKLOCAL_HEAD;

typedef struct sh3gfw_GSREGS_HEAD {
    // total size: 0x30
...
typedef struct sh3gfw_GIFTAG_HEAD {
    // total size: 0x10
...
typedef struct sh3gfw_TEX_HEAD {
    // total size: 0x30
...
typedef struct sh3gfw_CLUTS_HEAD {
    // total size: 0x30
    u_int clutssize;         // offset 0x0, size 0x4
...
typedef struct sh3gfw_Effect_Man {
    // total size: 0x40
